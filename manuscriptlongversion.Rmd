...
ofi and missing values in the used variables, age, gender, ISS, SBP, RR,
...
level 1 hospital, admits 1500 trauma patients each year. To have your
information added to the trauma registry, a patient must be over 15
...
This process was the only time AI was used in the writing process. It
...
In the following table, the results from the logistical regression
analysis is displayed.

The odds ratio is calculated both unadjusted and adjusted for other
variables, as well as a 95% confidence interval. The p value is also
shown.
...
delayed treatment, both unadjusted (ISS, OR 1.04, 95% CI 1.02-1.05)(RR,
OR 1.06, 95% CI 1.02-1.09) and adjusted (ISS, OR 1.03, 95% CI
...
prone to receiving delayed treatment. Compared to previous a previous
...
indicates severe trauma, as well as higher ISS. More injured patients
often entails a more complex management and require more interventions.
...
risk of missing a possible injury. A previous study also found this, but
the correlation dissapeared when adjusted for, which was hypothesised
being due to it's shared variability with the ISS
...
delayed treatment as their outcome, with many analysing mortality. Some
likeness exist with which patient level factors predict the outcome,
with higher mortality being seen in patients with lower GCS and higher
ISS [@Mort_sam][@Mort_hef]. Increased age was also a factor linked to
...
When looking at the patient demographic, it is clear that the majority
...
present in this study, though it is something that we can't control in
...
Another limitation with this study is that logistical regressions
...
single center study, where it's result only illustrates the situation in
