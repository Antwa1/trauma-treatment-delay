...
indicates severe trauma, aswell as higher ISS. More injured patients
...
they are more prone to delay in treatment.

Respiratory rate also had the correlation that lower respiratory rate
correlated with lower rates of delayed treatment among the patients. As
the interval is \>10 to \<29 in the triage guideline, both too low and
too high respiratory rate is not desirable[@EHCP2015]. This might have a
...
injured, therefore a higher risk of missing a possible injury. Another
possible explanation might be bradypnea in a patient might attract more
attention in the hospital and lower the incidence of delayed treatment.
Another similar study, which focused on ofi generally, showed the same
correlation, although the significance dissapeared in the adjusted
analysis [@Pat_factors].

Number of injuries was significant when unadjusted, but the correlation
dissapeared when adjusted for with other variables. Our guess as to why
this is due to confounding due to it's shared variability with the ISS
variable. Number of injuries and ISS is often correlated as a more
severely injured patient will both score higher on ISS and number of
injuries. Therefore, we hypothesize that the effect of number of
injuries become insignificant when adjusting for ISS.
...
delay to treatment group. The fact that age and gender did not show an
increased odds ratio should be seen as a positive sign. It suggests that
among trauma patients, there is no systematic delay based on gender or
age.
