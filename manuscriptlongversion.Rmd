...
set up to flag for patients with possible OFIs. Audit filters may
include low SBP, high RR, EMS scene time greater than 20 mins etc.
...
Selection bias as this is a retrospective, pots hoc cohort study where
...
visualize the adjusted and unadjusted regression.
...
variables and the presence of delayed treatment. A lower GCS had a
correlation with delayed treatment while a higher ISS had the same
correlation. This suggests that a more heavily injured and less awake
patient is more prone to receiving delayed treatment. Compared to
previous a previous study analysing the same data but with ofi as the
outcome, this result is similar to what they found using the same
database [@Pat_factors]. As the mentioned study suggests, this could be
explained by that lower GCS indicates severe trauma, aswell as higher
ISS. More injured patients often entails a more complex management and
require more interventions. More interventions leave more room for delay
to these interventions, why they are more prone to delay in treatment.
...
similar explanation to ISS and GCS, that bradypnea in a patient might
attract more attention in the hospital and lower the incidence of
delayed treatment. Another possible explanation might be that patients
with tachypnea might receive higher rates of delayed treatment because
they are more severely injured, therefore a higher risk of missing a
possible injury. Another similar study, which focused on ofi generally,
showed the same correlation, although the significance dissapeared in
the adjusted analysis [@Pat_factors].
...
there is no systematical delay based on gender or age.
...
Further discussing possible biases, misclassification bias might also be
...
be big enough to have a significant impact on the results, but should be
kept in mind.
...
Further discussing the results and discussing it's clinical
applications, the results can be interpreted as that it is mostly
injured and less awake patients that receive delayed. The clinical
applications for this are not clear, but caregivers should already be
aware that the more injuries a patients has, the more room for error
exists. It is good though to receive a reminder that it's important to
always work towards minimizing the delay for these injured patients.
