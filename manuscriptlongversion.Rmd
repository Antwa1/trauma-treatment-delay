...
patients flagged for audit filters might missclassify patients or that
...
of delayed treatment, both unadjusted (ISS, OR 0.96, 95% CI
0.95-0.98)(RR, OR 0.95, 95% CI 0.91-0.98) and adjusted (ISS, OR 0.97,
95% CI 0.95-0.99)(RR, OR 0.96, 95% CI 0.93-0.99). GCS had the opposite
correlation, with lower GCS often having lower incidence of delayed
treatment, both unadjusted (OR 1.13, 95% CI 1.07-1.20) and adjusted (OR
1.08, 95% CI 1.00-1.15). Number of injuries had the correlation of
higher number of injuries having lower incidence of delayed treatment
unadjusted (OR 0.94, 95% CI 0.91-0.98), but that correlation was not
...
Possible explanations to the correlation include the idea that
unconsious and more severely injured patients receive more immediate
attention at the hospital, leading to fewer delays.
...
distribution. However, Fischers test showed an association between 4 of
the 7 variables, all of them being the ones who showed an increased or
decreased risk of delayed treatment, showing that these results still
are significant.
...
uninjured and awake patients that receive delayed treatment. The
clinical applications for this are not clear, but might suggest that
personnel working with trauma patients should be aware of that people
that seem uninjured might be more likely to receive delayed treatment
and trying to lower that risk.
