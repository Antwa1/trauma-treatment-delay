...
hade delayed treatment. In the second logistical regression, 1,038
patients had missing data in one or more of the analysed parameters
which left 7,274 individuals group, 70 of which hade delayed treatment.
...
As we see in the results, there was one variable that, when adjusted,
had a correlation with the risk for a patient of receiving delayed
treatment, being the highest hospital care level. Compared with having
the ER as the highest care level, patients who were in the ICU or the OR
had a substantially lowered chance of receiving delayed treatment.
...
had a correlation with lower chance of delayed treatment.
